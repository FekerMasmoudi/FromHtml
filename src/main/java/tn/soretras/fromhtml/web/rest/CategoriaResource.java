...
import tn.soretras.fromhtml.service.CategoriaService;
import tn.soretras.fromhtml.service.dto.CategoriaDTO;
import tn.soretras.fromhtml.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link tn.soretras.fromhtml.domain.Categoria}.
 */
@RestController
@RequestMapping("/api")
public class CategoriaResource {
    ...
    public ResponseEntity<List<CategoriaDTO>> getAllCategorias(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
